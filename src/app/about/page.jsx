...
export default function About() {
  return (
    <>
      <Head>
        <title>About Us | Essence Massage Studio London</title>
        <meta
          name="description"
          content="Meet the team and discover the story behind Essence Massage Studio in Chiswick, London. Professional, certified therapists dedicated to your wellness."
        />
        <meta
          name="keywords"
          content="about Essence Massage Studio, massage therapists London, Chiswick massage team, wellness studio, professional massage, London spa team"
        />
        <meta
          property="og:title"
          content="About Us | Essence Massage Studio London"
        />
        <meta
          property="og:description"
          content="Meet the team and discover the story behind Essence Massage Studio in Chiswick, London. Professional, certified therapists dedicated to your wellness."
        />
        <meta property="og:image" content="/frontlocation.jpeg" />
        <meta
          property="og:url"
          content="https://essencemassagestudio.co.uk/about"
        />
        ...
        <meta
          ...
          content="Meet the team and discover the story behind Essence Massage Studio in Chiswick, London. Professional, certified therapists dedicated to your wellness."
        />
        <meta name="twitter:image" content="/frontlocation.jpeg" />
      </Head>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <div className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed space-y-6">
                ...
                <p>
                  Embrace the luxury of diverse massage techniques, each
                  artfully designed to cater to your unique needs; you'll feel
                  yourself descend into a blissful state with the gentle rhythm
                  of each stroke, as you're transported to a realm of utter
                  serenity, where worries are left behind and calmness becomes
                  your companion.
                </p>
              </div>
              <div className="pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Restorative, professional and welcoming environment designed
                  to help you unwind and relax completely.
                </p>
              </div>
